...
const Read_Efuse operation_3 = {.offset = 0x5ea, .efuse_start = 0x0, .size = 1, .read_efuse_cnt = 10000, .efuse_ctrl = 0x30, .dv_sel = EfuseAccess_DDV, .map_ptr = 0xda5708c1};
const Another_Cmd operation_4 = {.num = 3.565, .adv = EfuseAccess_DAV, .top = -2500, .adu = EfuseAccess_DXV, .dot = array_2};
